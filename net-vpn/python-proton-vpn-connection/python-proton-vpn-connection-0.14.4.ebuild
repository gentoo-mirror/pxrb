...
HOMEPAGE="https://protonvpn.com https://github.com/ProtonVPN/python-proton-vpn-connection"
SRC_URI="https://github.com/ProtonVPN/python-proton-vpn-connection/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz"
